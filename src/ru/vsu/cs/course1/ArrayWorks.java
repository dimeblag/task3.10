...
/*
    ...
    public static Stack<Position> findPathToFinish(int sizeOfField, Position knight, Position finish) {
        List<List<Position>> edges = ArrayWorks.fillAdjacencyList(sizeOfField);
    ...
    public static int[][] showPathToFinish(Stack<Position> stack, int sizeOfField) {
